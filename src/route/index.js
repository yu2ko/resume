          ...
          projects: [
            {
              ...
              about:
                'Airbnb.High-load application for searching apartmens',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                ...
                {
                  name: 'Preparing SEO optimized pages.The automated process of getting data for the app for documents.',
                },
              ],
              stackAmount: 3,
              awardAmount: 2,
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrap01-02', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrap01-02', {
    layout: 'bootstrap',

    page: {
      title: 'Bootstrap01-02',
    },
  })
  //                  ↑↑ сюди вводимо JSON дані
})
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrap03', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrap03', {
    layout: 'bootstrap',
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrap04', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrap04', {
    layout: 'bootstrap',
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrap05', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrap05', {
    layout: 'bootstrap',
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrap06', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrap06', {
    layout: 'bootstrap',
